...
This is not a second LMS, a quantified-self game, or a public biography. It is the personal operating layer of the Starlight Academy Fabric:

- **GitHub** holds the share-safe ontology, curricula, profile contracts, rubrics, and automation specifications.
- **Notion** holds Frank's private operating projection: current capabilities, evidence, reviews, priorities, and stewardship commitments.
- **Google Drive** holds human-readable field guides, original evidence, signed/permissioned records, and the measurement workbook.
- **Public profile projections** are derived, consented, selective, and revocable. No private relationship, health, financial, or identity record belongs in the public repository.
...
- What evidence is current, and what has decayed?
...
|---|---|---|
| Explorer | Can I map the territory and its boundaries? | Accurate explanation, glossary map, identified unknowns |
| Apprentice | Can I perform with guidance? | Completed practice and reviewed artifact |
| Practitioner | Can I produce a repeatable result independently? | Multiple artifacts, at least two contexts, correction history |
...
The operational ledger records five primary event types:

1. **Learned** - a concept was retrieved, explained, or connected accurately.
2. **Built** - a working artifact, decision, system, experiment, performance, or experience was produced.
3. **Taught** - a lesson, tutorial, workshop, example, or assessment enabled another learner.
4. **Refined** - an existing artifact, method, standard, agent, relationship practice, or body of knowledge was materially improved.
5. **Guided** - a person or agent received accountable direction and moved toward independent capability.

Supporting events include observed, practiced, reviewed, transferred, contributed, published, retired, and retracted.

## Capability constellations

The Knowledge Tree should organize Frank's development into coherent constellations, not hundreds of disconnected goals.

1. Founder sovereignty and state regulation
2. Venture strategy, portfolio design, and economic systems
3. Finance, accounting, capital allocation, and investing
4. Product judgment, user value, and commercialization
5. AI architecture, agent systems, software, data, and security
6. Research, epistemology, invention, and experimentation
7. Design, taste, worldbuilding, narrative, and experience direction
8. Media, content, distribution, persuasion, and reputation
9. Sales, negotiation, partnerships, and institutional adoption
10. Leadership, delegation, culture, and multi-agent organizations
11. Teaching, curriculum, assessment, mentorship, and institution building
12. Love, partnership, sexuality, marriage, and family stewardship
13. Friendship, hospitality, tribe, community, and civic contribution
14. Health, strength, energy, recovery, and longevity
15. Music, performance, artistic craft, and creative production
16. Philosophy, ethics, spirituality, meaning, and civilization
17. Lifestyle architecture, geography, mobility, and freedom
18. Stewardship archetypes: Owner, Investor, Architect, Teacher, Partner, Kin, Friend, Host, Artist, Lover, King, and Magician
...
- `subject`: human, agent, or team;
- `capability`: stable capability identifier;
- `verb`: learned, built, taught, refined, guided, or supporting event;
...
- `human_contribution` and `agent_contribution`: declared roles, never a fake precision percentage;
...
- `confidence`: provisional, supported, calibrated, or contested.
...
- Capture at most three meaningful events across the five verbs.
- Attach evidence or mark the claim as unverified.
- Name one correction, one promise, and one next practice.
...
- Promote, hold, decay, contest, or retract claims.
...
- Review who or what became more capable because of Frank's work.
...
The first release must not attempt to score Frank across all of life. It should prove the operating loop in three high-leverage constellations:
...
|---|---|---|
| Public GitHub | Ontology, templates, curricula, rubrics, synthetic examples, public artifacts | Personal relationship records, health data, finances, private names, private reflections |
| Private Notion | Current priorities, evidence links, reviews, role covenants, consent state | Raw secrets, credentials, unnecessary intimate detail |
| Private Drive | Original evidence, signed/permissioned documents, rich field guide, workbook | Uncontrolled public sharing |
| Public profile | Selected capabilities and artifacts with explicit consent | Whole-life scoring, inferred traits, hidden agent authorship, non-consenting people |
...
- One share-safe public specification and profile template in GitHub.
- One private Notion hub with capability, evidence, and stewardship ledgers.
- One Drive field guide and one auditable tracking workbook.
